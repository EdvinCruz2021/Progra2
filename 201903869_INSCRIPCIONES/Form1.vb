Public Class Form1
    ...
    Private Sub Btn_Resultados_Click(sender As Object, e As EventArgs) Handles btn_result.Click
        Dim r As Byte = 0
        ...
        Text_totalefec.Text = Math.Round(r2, 2).ToString
        Text_totaltarj.Text = Math.Round(r3, 2).ToString
        Text_totaltrans.Text = Math.Round(r4, 2).ToString
        Text_Totaldepo.Text = Math.Round(r5, 2).ToString
    ...
    Private Sub BTN_LIMPIAR_RES_Click(sender As Object, e As EventArgs) Handles btn_limpiar.Click
        Text_totalG.Text = ""
        Text_totalefec.Text = ""
        Text_totaltarj.Text = ""
        Text_totaltrans.Text = ""
        Text_Totaldepo.Text = ""
        Text_totalbas.Text = ""
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn_limpiare.Click
        LIMPIAR_ENTRADAS()
    End Sub

    Private Sub BTN_FILA_Click(sender As Object, e As EventArgs) Handles btn_efila.Click
        Dim i As Integer
